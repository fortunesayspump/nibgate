...
export function exploreHeader() {
  return `<header class="explore-header">
    <div class="explore-header-main">
      <a class="explore-logo" href="${exploreRoutes.home}">nibgate</a>
      ...
      <div class="explore-auth-links">
        <a href="${exploreRoutes.home}">Log in</a>
        <a href="${exploreRoutes.home}">Start selling</a>
      </div>
    </div>
    ${categoryNav()}
  </header>`;
