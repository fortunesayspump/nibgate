...
export async function createApp(config, options = {}) {
  ...
  app.use(cors((req, callback) => {
    if (req.path === '/api/hub/pay' || req.path === '/api/hub/evt' || req.path === '/api/hub/track' || req.path === '/api/hub/reputation/ratings/prepare' || req.path === '/api/hub/reputation/ratings/index') {
