...
| MCP server | `POST https://api.nibgate.xyz/mcp` (Streamable HTTP) | `explore_content`, `get_ledger`, `get_platform_stats`, `get_leaderboards` |
...
```bash
curl -i 'https://pitchtalk.nibgate.xyz/api/nibgate/access?path=/writing/the-tactic-that-changed-modern-football' \
...
payment-required: 
...
```json
{
  "x402Version": 2,
  "resource": {
    "url": "/posts/the-tactic-that-changed-modern-football",
...
const result = await agent.pay(
  'https://pitchtalk.nibgate.xyz/api/nibgate/access?path=/writing/the-tactic-that-changed-modern-football',
...
```json
{
  ...
  "resource": {
    ...
    "price": "0.50",
    "currency": "USDC",
    "path": "/posts/the-tactic-that-changed-modern-football",
