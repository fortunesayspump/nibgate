...
The ledger at `https://nibgate.xyz/ledger` (API: `GET /hub/ledger`) provides a live feed of all views, unlocks, payments, and ratings across sites. Agents can filter by `?domain=` for per-site activity. Each entry includes timestamps, wallet addresses, and on-chain tx hashes where applicable.
...
const result = await agent.pay(
  'https://creator.example/api/writing/my-article',
  {
