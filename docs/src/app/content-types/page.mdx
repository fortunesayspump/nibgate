...
**Paid gating**: When a photo set is paid, the gallery preview shows blurred or count-limited thumbnails. The full gallery is revealed after unlock.
...
**Player**: A custom audio player is rendered on the post page with play/pause, progress, and volume controls.

**Paid gating**: When gated, the player shows a preview (e.g. 30 seconds) or requires unlock for full playback.
