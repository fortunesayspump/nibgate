...
The widget on the creator site streams activity to `/api/hub/evt`: page views, resource views, time spent, scroll depth, and unlock/payment events. Each resource event carries the resource id, title, type, price, path, and image URL.
