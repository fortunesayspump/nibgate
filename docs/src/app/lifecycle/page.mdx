...
The eligible wallet can submit a rating proof or onchain rating event, depending on the site/product configuration.
...
The package resolves the content id, checks unlock eligibility, and handles the rating submission path.
