...
<meta name="nibgate:access" content="https://api.nibgate.xyz/api/nibshare/DxqTvRKJ/access"/>
<meta name="nibgate:manifest" content="https://api.nibgate.xyz/api/nibshare/DxqTvRKJ/manifest"/>
```
...
`GET /api/nibshare/:slug/manifest` is the canonical, structured contract:

```bash
curl -s https://api.nibgate.xyz/api/nibshare/DxqTvRKJ/manifest | jq
```
...
```json
{
  ...
  "urls": {
    ...
    "meta": "https://api.nibgate.xyz/api/nibshare/DxqTvRKJ/meta",
    "manifest": "https://api.nibgate.xyz/api/nibshare/DxqTvRKJ/manifest",
    "access": "https://api.nibgate.xyz/api/nibshare/DxqTvRKJ/access",
    "unlock": "https://api.nibgate.xyz/api/nibshare/DxqTvRKJ/unlock",
    "media": "https://api.nibgate.xyz/api/nibshare/DxqTvRKJ/media/{kind}?index=N"
  },
  "payment": {
    "scheme": "x402",
...
The single read route is `GET /api/nibshare/:slug/access`:
...
```bash
curl -s https://api.nibgate.xyz/api/nibshare/DxqTvRKJ/access \
...
- Manifest route: `GET /api/nibshare/:slug/manifest` in `backend/src/server/nibshare/routes.js`
