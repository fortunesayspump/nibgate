...
For multipublisher platforms, creator reputation can also roll up from publisher identities. A creator who connects `0xAlice` on `platform.com` and signs into Nibgate with `0xAlice` should see reputation from `platform.com/@alice` alongside any personal sites she owns.
...
<Cards>
  ...
  <Cards.Card title="Creator reputation" href="/reputation#creator-reputation">
    A 1-100 score for the wallet/account that owns verified sites or wallet-linked publisher identities.
  </Cards.Card>
...
Creator reputation is a 1-100 score attached to the wallet/account that owns verified sites or verified publisher identities.

It should roll up from:

- content star ratings
- site reputation
- publisher identity reputation from platforms
...
On multipublisher platforms, Nibgate should attribute reputation using the verified site, publisher id, publisher wallet, content id, canonical URL, payment recipient, and receipt or rating proof. The creator's platform wallet should match the wallet used to sign into Nibgate.
