...
Nibgate reputation starts with content. A creator should not earn abstract trust points just for existing; trust should come from paid unlocks, receipts, onchain ratings, and verified source health attached to actual resources.
...
<Cards>
  ...
  <Cards.Card title="Creator reputation" href="/reputation#creator-reputation">
    A 1-100 score for the wallet/account that owns verified sites and their content.
  </Cards.Card>
...
The rating itself can be an onchain event after eligibility is proven.
...
Nibgate indexes the rating event and updates content stars.
