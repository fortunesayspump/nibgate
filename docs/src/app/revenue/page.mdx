...
Reader wallet
  ...
  -> Package reports receipt to Nibgate hub (amount + derived protocolFee)
  -> Keeper sweeps the wallet: gatewayMint then distribute() pays 99% to the creator EOA, 1% to treasury
