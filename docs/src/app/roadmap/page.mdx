...
- Work the `FOLLOWUPS.md` P1–P8 items and wallet-unify follow-ups (ReputationRating raw `window.ethereum`, dead `GatewayWallet.tsx`, widget.js Reown parity).
