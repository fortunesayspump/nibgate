...
(async () => {
  ...
  const ibtn = home.locator('[data-testid="import-account-confirm-button"]').first();
  console.log('import btn enabled:', await ibtn.isEnabled());
  await ibtn.click(); // intentional, non-force
