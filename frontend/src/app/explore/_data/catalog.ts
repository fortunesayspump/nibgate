import { creatorAvatar, featuredArt, marketArt } from './assets';
...
const featuredProductSeeds = [
  { type: 'Article', title: 'Magic Monthly: Notes for Paid Publishing', summary: 'A monthly field guide on building a sharper paid publication without moving your audience off-site.', creator: 'Christian Grace', price: '£12.99 a month', meta: '8 min read', unlocks: '390 unlocks' },
  { type: 'Writing', title: 'Atravesando el Desierto', summary: 'A longform guide for readers moving through a difficult creative season with more clarity.', creator: 'Javier', price: '€14.99', meta: 'Private essay', unlocks: '86 unlocks' },
  { type: 'Music', title: 'Awake: Audiobook Edition', summary: 'A spoken audio release on attention, soft lies, and how to think before the feed thinks for you.', creator: 'House of El', price: '£14.95', meta: '2 hr 18 min', unlocks: '121 unlocks' },
  { type: 'Video', title: 'The Real Fermentation System', summary: 'A focused video course for creating confident ferments with a simple kitchen system.', creator: 'David Levitsky', price: '$57', meta: '42 min video', unlocks: '64 unlocks' },
  { type: 'Article', title: 'Hacking with Swift+: Route Notes', summary: 'A technical publishing archive for Swift developers who want practical paid programming notes.', creator: 'Paul Hudson', price: '$20 a month', meta: 'Updated weekly', unlocks: '297 unlocks', topCreator: true },
  { type: 'Music', title: 'GSonic Immersive 1.1.7', summary: 'A sound measurement toolkit and audio walkthrough for tuning home cinema spaces.', creator: 'S Guer', price: '$74.99', meta: 'Audio toolkit', unlocks: '132 unlocks' },
  { type: 'Image', title: 'Manga Megapack: Brush Studies', summary: 'A visual pack for making clean anime-style panels, covers, and production-ready illustration work.', creator: 'MANGA BRUSH', price: '$0+', meta: '3000+ assets', unlocks: '517 unlocks' },
  { type: 'Music', title: 'GMaudio Ducker 1.6', summary: 'A precise Ableton Live audio utility for clean side-chain movement in creator-made tracks.', creator: 'Robert K//Groov Mekanik', price: '$18+', meta: 'Ableton pack', unlocks: '89 unlocks' }
];
...
export const wishlists = [
  { title: 'free resources god bless', creator: 'cal', products: '554 products', followers: '2.1K followers', images: ['01', '02', '03', '04'], avatar: '05' },
  { title: 'Free assets/ avatar ( for more go to my profile)', creator: 'Quinn Flora', products: '100 products', followers: '880 followers', images: ['06', '07', '08', '09'], avatar: '10' },
  { title: 'FREEEE', creator: 'CookieO3O_VR', products: '98 products', followers: '524 followers', images: ['11', '12', '13', '14'], avatar: '15' },
  { title: 'Free Procreate Brushes', copy: 'because I have a problem', creator: 'KharmaKhay', products: '69 products', followers: '659 followers', images: ['16', '17', '18', '19'], avatar: '20' }
];
