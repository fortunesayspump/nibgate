...
export default function ActivityBell({ activity }: { activity: ShareActivity[] }) {
  ...
  return (
    <div className="relative" ref={wrapRef}>
      ...
      {open && (
        <div className="nibshare-activity-dropdown absolute right-0 top-full mt-2 w-80 rounded-lg border shadow-xl z-50 overflow-hidden nibshare-root" style={{ borderColor: "var(--border)", background: "var(--bg)", maxWidth: "min(20rem, calc(100vw - 16px))" }}>
