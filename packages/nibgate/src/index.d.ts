...
export declare function contentHashFor(domain: string, externalId: string, url: string): string;
export declare function canonicalContentHash(resource: NibgateResource | string): string | undefined;
