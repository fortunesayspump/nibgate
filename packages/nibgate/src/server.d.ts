...
export declare function packCipherBlob(enc: { iv: Uint8Array; tag: Uint8Array; ciphertext: Uint8Array }): Buffer;
export declare function unpackCipherBlob(blob: Uint8Array | Buffer): { iv: Buffer; tag: Buffer; ciphertext: Buffer };
export declare function wrapKey(secret: Uint8Array | Buffer | string, key: Uint8Array | Buffer): string;
export declare function unwrapKey(secret: Uint8Array | Buffer | string, wrappedB64: string): Buffer;
export declare function contentHashFor(ownerWallet: string, storageRef: string, plaintext: string | Uint8Array): string;
export declare function registerProvider(name: string, factory: (config?: Record<string, unknown>) => unknown, config?: Record<string, unknown>): void;
