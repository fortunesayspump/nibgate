          ...
          {numberOfNewPostsLoaded !== 0 && (
            <motion.div
              ...
              <ButtonNaked
                ...
                className="mt-4 inline-flex cursor-pointer select-none items-center gap-3 rounded-md bg-slate-950 px-4 py-2 text-white shadow-sm hover:bg-emerald-700">
                <div className="-rotate-90 rounded-md border border-white/20 bg-white/10 p-[6px]">
