...
export function DatePicker({ triggerRef, ...props }: DatePickerProps) {
  ...
  return (
    <>
      <div
        className={cn(
          'relative flex-col rounded-md border border-border bg-white pb-2 pr-5 pt-8 text-left text-sm outline-none ring-emerald-700 focus-within:border-emerald-300 focus-within:ring-2',
