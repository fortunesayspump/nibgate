    ...
    <>
      <div className="relative">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            'peer w-full rounded-md border border-border bg-white pb-2 pr-5 pt-8 text-sm text-slate-950 outline-none ring-emerald-700 focus:border-emerald-300 focus:ring-2',
            Icon ? 'pl-16' : 'pl-5',
