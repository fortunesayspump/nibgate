      ...
      <>
        <div className="relative">
          ...
          <textarea
            ...
            ref={ref}
            className={cn(
              'peer block w-full resize-none overflow-hidden rounded-md border border-border bg-white pb-2 pr-5 pt-8 text-sm text-slate-950 outline-none ring-emerald-700 focus:border-emerald-300 focus:ring-2',
              Icon ? 'pl-16' : 'pl-5',
              isError && 'border-red-200 bg-destructive ring-destructive/30 focus:ring-4',
              className,
            )}
            rows={1}
            placeholder=" "
          ...
          <label
            className={cn(
              'absolute top-[9px] z-0 translate-y-0 cursor-text text-xs font-semibold transition-all peer-placeholder-shown:top-[50%] peer-placeholder-shown:translate-y-[-50%] peer-placeholder-shown:text-sm peer-focus:top-[9px] peer-focus:translate-y-0 peer-focus:text-xs',
              Icon ? 'left-16' : 'left-5',
